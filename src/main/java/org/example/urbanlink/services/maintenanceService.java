package org.example.urbanlink.services;
...
public class maintenanceService implements CRUD<Maintenance> {
    ...
    @Override
    public int delete(Maintenance maintenance) throws SQLException {
    ...
    public List<Maintenance> showAll() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            Vehicle vehicle = vehicleService.getById(vehicleId); // Now it's called on an instance
