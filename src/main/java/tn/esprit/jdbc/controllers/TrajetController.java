...
public class TrajetController {
    ...
    public void handleAddTrajet() {
        try {
            ...
            // Récupérer les heures et minutes et les formater
            String duration = formatTime(durationHourField.getText(), durationMinuteField.getText());
            ...
            // Confirmation d'ajout du trajet
